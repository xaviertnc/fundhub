...
<form action="<?=esc_url( admin_url( 'admin-post.php' ) )?>" method="post">
  ...
  <p><label><input type="checkbox" name="keep_plugins" checked> Restore Currently Active Plugins</label></p>
  <p><label><input type="checkbox" name="keep_theme" checked> Restore Current Theme</label></p>
  <?=$nonce_field?>
